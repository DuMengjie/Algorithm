...
// Tests
// Test.assertEquals(deNico("crazy","cseerntiofarmit on  " ),"secretinformation" );
// Test.assertEquals(deNico("crazy","cseerntiofarmit on" ),"secretinformation" );
// Test.assertEquals(deNico("abc", "abcd"),"abcd" );
// Test.assertEquals(deNico("ba","2143658709" ), "1234567890");
// Test.assertEquals(deNico("a", "message"),"message" );
// Test.assertEquals(deNico("key", "eky"),"key" );
